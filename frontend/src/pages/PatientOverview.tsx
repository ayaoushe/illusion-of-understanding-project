...
import { PatientSummaryCard } from '../components/cards/PatientSummaryCard';
  ...
  return (
    <div className="page">
      <PageHeader
        ...
        subtitle="Review the complete clinical picture before forming your independent assessment."
        badge="Step 1"
      />

      <PatientSummaryCard patient={mockPatient} />
      ...
      <div className="overview-grid">
        ...
        <ClinicalInfoCard title="Pathology & Molecular" collapsible>
        ...
        <ClinicalInfoCard title="Imaging Summary" collapsible>
      ...
      <MissingDataCard items={mockPatient.missingData} />
