...
export const similarCasesByPatient: SimilarCasesByPatient = {
  'P-0001568': [
    {
      caseId: 'Case #A-001',
      caseType: 'supporting',
      matchScore: 90,
      matchCriteria: [
        { label: 'Breast cancer diagnosis', matched: true },
        { label: 'Stage IIA', matched: true },
        { label: 'Ductal histology', matched: true },
        { label: 'ECOG 1', matched: true },
        { label: 'Diabetes mellitus', matched: true },
        { label: 'Hypertension', matched: true },
      ],
      presentation: 'Female, 63y, HR-positive breast cancer Stage IIA, ductal carcinoma, ECOG 1',
      treatmentUsed: 'Breast-conserving surgery + endocrine therapy',
      outcome: 'Stable disease control with maintained function over 24 months',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIA', 'Ductal carcinoma', 'ECOG 1', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Tumor laterality',
          currentPatient: 'Right breast',
          comparisonCase: 'Right breast',
        },
        {
          feature: 'Nodal status',
          currentPatient: 'not documented',
          comparisonCase: 'no clinically enlarged nodes documented',
        },
      ],
      takeaway: 'Sehr ähnlich in Stadium, Histologie und Komorbiditäten; dient als prototypischer Fall eines HR-positiven Brustkrebses mit moderatem Risiko.',
    },
    {
      caseId: 'Case #A-002',
      caseType: 'counterfactual',
      matchScore: 74,
      matchCriteria: [
        { label: 'Breast cancer diagnosis', matched: true },
        { label: 'Stage IIA', matched: true },
        ...
        { label: 'ECOG 1', matched: true },
        { label: 'Diabetes mellitus', matched: true },
        { label: 'HER2 negative', matched: true },
        { label: 'Node-positive presentation', matched: false },
      ],
      presentation: 'Female, 62y, HR-positive breast cancer Stage IIA, ductal carcinoma, node-positive workup, ECOG 1',
      treatmentUsed: 'Neoadjuvant chemotherapy + surgery',
      outcome: 'Pathologisches Ansprechen, aber höhere Therapiebelastung',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIA', 'Ductal carcinoma', 'ECOG 1', 'Diabetes', 'Hypertension'],
      differences: [
        {
          ...
          currentPatient: 'not documented',
          comparisonCase: 'node-positive',
        },
        {
          feature: 'Therapieintensität',
          currentPatient: 'not documented',
          comparisonCase: 'neoadjuvante Chemotherapie erforderlich',
        },
      ],
      takeaway: 'Zeigt einen eng verwandten Brustkrebsszenario mit unterschiedlichem lymphatischem Befund und daraus folgend einer intensiveren Therapieplanung.',
    },
    {
      caseId: 'Case #A-003',
      caseType: 'rare',
      ...
      matchCriteria: [
        { label: 'Breast cancer diagnosis', matched: true },
        { label: 'Stage IIA', matched: true },
        { label: 'Mixed histology', matched: false },
        { label: 'ECOG 1', matched: true },
        { label: 'Diabetes mellitus', matched: true },
        { label: 'Hypertension', matched: true },
      ],
      presentation: 'Female, 65y, HR-positive mixed ductal-lobular breast cancer Stage IIA, ECOG 1',
      treatmentUsed: 'Erweiterte Resektion + Strahlentherapie + endokrine Therapie',
      outcome: 'Komplexe Nachsorge, aber lokale Kontrolle erreicht',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIA', 'Brustkrebs', 'ECOG 1', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Histologie-Subtyp',
          currentPatient: 'Ductal carcinoma',
          comparisonCase: 'Mixed ductal-lobular carcinoma',
        },
        {
          feature: 'Therapiekomplexität',
          currentPatient: 'not documented',
          comparisonCase: 'erweiterte Resektion plus adjuvante Strahlentherapie',
        },
      ],
      takeaway: 'Ein seltener Fall mit gemischtem histologischem Bild, der die Übertragbarkeit auf Standardszenarien einschränkt.',
    },
  ],
  'P-0000081': [
    {
      ...
      matchCriteria: [
        { label: 'Breast cancer diagnosis', matched: true },
        { label: 'Stage IIB', matched: true },
        { label: 'Lobular histology', matched: true },
        { label: 'ECOG 0', matched: true },
        { label: 'Diabetes mellitus', matched: true },
        { label: 'Hypertension', matched: true },
      ],
      presentation: 'Female, 58y, HR-positive lobular breast cancer Stage IIB, ECOG 0',
      treatmentUsed: 'Breast-conserving surgery + endocrine therapy',
      outcome: 'Kein lokoregionärer Rückfall nach 22 Monaten, gute Lebensqualität',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIB', 'Lobular carcinoma', 'ECOG 0', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Laterality',
          currentPatient: 'Left breast',
          comparisonCase: 'Left breast',
        },
        {
          feature: 'Nodalbefall',
          currentPatient: 'not documented',
          comparisonCase: 'kein nodaler Befall beschrieben',
        },
      ],
      takeaway: 'Typischer HR-positiver lobulärer Brustkrebs mit ähnlichem Stadium und funktionellem Status.',
    },
    {
      caseId: 'Case #B-002',
      caseType: 'counterfactual',
      ...
      presentation: 'Female, 57y, HR-positive lobular breast cancer Stage IIB, node-positive, ECOG 0',
      treatmentUsed: 'Operative Resektion + adjuvante Chemotherapie',
      outcome: 'Gute Krankheitskontrolle, aber erhöhte Nebenwirkungsbelastung',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIB', 'Lobular carcinoma', 'ECOG 0', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Lymphknotenstatus',
          currentPatient: 'not documented',
          comparisonCase: 'node-positive',
        },
        {
          feature: 'Therapieachse',
          currentPatient: 'not documented',
          comparisonCase: 'Resektion plus Chemotherapie',
        },
      ],
      takeaway: 'Ein ähnlicher Lobular-Fall mit einer zusätzlichen nodalen Komponente, der zu einer intensiveren Nachbehandlung führt.',
    },
    {
      caseId: 'Case #B-003',
      caseType: 'rare',
      ...
      matchCriteria: [
        ...
        { label: 'Lobular histology', matched: true },
        { label: 'ECOG 0', matched: true },
        { label: 'Bilateral Befall', matched: false },
        { label: 'Diabetes mellitus', matched: true },
      ],
      presentation: 'Female, 60y, HR-positive bilateraler lobulärer Brustkrebs Stage IIB, ECOG 0',
      treatmentUsed: 'Bilaterale Lumpektomie + adjuvante Strahlentherapie',
      outcome: 'Lokale Kontrolle erreicht, aber komplexe Rekonstruktionsplanung',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIB', 'Lobular carcinoma', 'ECOG 0', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Befallsmuster',
          currentPatient: 'einseitig',
          comparisonCase: 'bilateral',
        },
        {
          feature: 'Operative Komplexität',
          currentPatient: 'not documented',
          comparisonCase: 'bilaterale Lumpektomie',
        },
      ],
      takeaway: 'Ein seltener bilateraler lobulärer Brustkrebsfall, der die Übertragbarkeit auf Standardfälle einschränkt.',
    },
  ],
  'P-0002566': [
    {
      ...
      matchScore: 91,
      matchCriteria: [
        { label: 'Lung adenocarcinoma', matched: true },
        { label: 'Stage IIIB', matched: true },
        { label: 'Adenocarcinoma histology', matched: true },
        { label: 'ECOG 2', matched: true },
        { label: 'Kidney impairment', matched: true },
        { label: 'Diabetes mellitus', matched: true },
      ],
      presentation: 'Female, 71y, EGFR-positive lung adenocarcinoma Stage IIIB, ECOG 2',
      treatmentUsed: 'Osimertinib 80mg daily',
      outcome: 'Stabile Krankheitskontrolle über 16 Monate bei guter Verträglichkeit',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIIB', 'Adenocarcinoma', 'ECOG 2', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Tumorort',
          currentPatient: 'Left upper lobe',
          comparisonCase: 'Left upper lobe',
        },
        {
          feature: 'Symptomatische Darstellung',
          currentPatient: 'not documented',
          comparisonCase: 'leichte Dyspnoe bei Diagnose',
        },
      ],
      takeaway: 'Sehr ähnlicher NSCLC-Fall mit vergleichbarer Funktionsfähigkeit und Komorbiditäten, der EGFR-TKI als systemische Option zeigt.',
    },
    {
      caseId: 'Case #C-002',
      caseType: 'counterfactual',
      ...
      matchCriteria: [
        ...
        { label: 'ECOG 2', matched: true },
        { label: 'Diabetes mellitus', matched: true },
        { label: 'EGFR wild type', matched: false },
      ],
      presentation: 'Female, 70y, EGFR-wildtyp lung adenocarcinoma Stage IIIB, ECOG 2',
      treatmentUsed: 'Carboplatin + Pemetrexed',
      outcome: 'Partielle Remission, aber erhöhte Toxizität',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIIB', 'Adenocarcinoma', 'ECOG 2', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'EGFR mutation',
          currentPatient: 'EGFR positive',
          comparisonCase: 'EGFR wild type',
        },
        {
          feature: 'Behandlungsansatz',
          currentPatient: 'not documented',
          comparisonCase: 'platinum-basierte Chemotherapie',
        },
      ],
      takeaway: 'Ein enges Lungencase mit einem entscheidenden molekularen Unterschied, der die systemische Therapie beeinflusst.',
    },
    {
      caseId: 'Case #C-003',
      caseType: 'rare',
      ...
      matchCriteria: [
        ...
        { label: 'Adenocarcinoma histology', matched: true },
        { label: 'ECOG 2', matched: true },
        { label: 'Extensive segmental involvement', matched: false },
        { label: 'Anemia management', matched: true },
      ],
      presentation: 'Female, 72y, segmental EGFR-positive lung adenocarcinoma Stage IIIB, ECOG 2, geringe Anämie',
      treatmentUsed: 'Osimertinib + supportive anemia care',
      outcome: 'Kontrollierter Verlauf, aber komplexere Symptomsteuerung',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IIIB', 'Adenocarcinoma', 'ECOG 2', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'Tumorausbreitung',
          currentPatient: 'not documented',
          comparisonCase: 'segmentale Infiltration mit begrenzter GGO-Komponente',
        },
        {
          feature: 'Supportive Care Bedarf',
          currentPatient: 'not documented',
          comparisonCase: 'zusätzliche Anämiebehandlung',
        },
      ],
      takeaway: 'Ein weniger übertragbarer Lungencase mit komplexerer Lokalverteilung und Supportivbedürfnissen.',
    },
  ],
  'P-0001862': [
    {
      ...
      matchScore: 93,
      matchCriteria: [
        { label: 'Oligometastatic NSCLC', matched: true },
        { label: 'Stage IVA', matched: true },
        { label: 'Adenocarcinoma histology', matched: true },
        { label: 'ECOG 1', matched: true },
        { label: 'EGFR-positive', matched: true },
        { label: 'Diabetes mellitus', matched: true },
      ],
      presentation: 'Female, 67y, oligometastatic EGFR-positive NSCLC Stage IVA, ECOG 1',
      treatmentUsed: 'Osimertinib + lokale Ablationsradiotherapie',
      outcome: 'Stabile Erkrankung bei guter Funktion, lokales Management einer isolierten Metastase',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IVA', 'Adenocarcinoma', 'EGFR-positive', 'ECOG 1', 'Hypertension'],
      differences: [
        {
          feature: 'Metastasenort',
          currentPatient: 'nicht dokumentiert',
          comparisonCase: 'isolierte lokale Metastasenbehandlung',
        },
        {
          feature: 'Therapiekomponente',
          currentPatient: 'not documented',
          comparisonCase: 'lokale Ablation ergänzt Systemtherapie',
        },
      ],
      takeaway: 'Ein eng verwandter oligometastatischer NSCLC-Fall mit übereinstimmender molekularer Charakteristik und zusätzlichem lokalem Management.',
    },
    {
      caseId: 'Case #D-002',
      caseType: 'counterfactual',
      ...
      presentation: 'Female, 67y, oligometastatic EGFR-wildtyp NSCLC Stage IVA, ECOG 1',
      treatmentUsed: 'Carboplatin + Pemetrexed + Pembrolizumab',
      outcome: 'Partielle Remission bei höherem Toxizitätsprofil',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IVA', 'Adenocarcinoma', 'ECOG 1', 'Diabetes', 'Hypertension'],
      differences: [
        {
          feature: 'EGFR mutation',
          currentPatient: 'EGFR-positive',
        ...
        {
          feature: 'Systemtherapie',
          currentPatient: 'not documented',
          comparisonCase: 'Immunochemotherapie statt TKI',
        },
      ],
      takeaway: 'Zeigt einen ähnlichen oligometastatischen NSCLC-Fall mit einem entscheidenden molekularen Abweichungspunkt.',
    },
    {
      caseId: 'Case #D-003',
      caseType: 'rare',
      ...
      matchCriteria: [
        ...
        { label: 'Adenocarcinoma histology', matched: true },
        { label: 'ECOG 1', matched: true },
        { label: 'Adrenal metastasis', matched: false },
        { label: 'Local ablative therapy', matched: true },
      ],
      presentation: 'Female, 68y, oligometastatic EGFR-positive NSCLC Stage IVA mit isolierter Nebennierenmetastase, ECOG 1',
      treatmentUsed: 'Osimertinib + stereotaktische Ablation der Nebennierenmetastase',
      outcome: 'Symptomatische Kontrolle erreicht, aber eingeschränkte Übertragbarkeit',
      source: 'Synthetic study case — for prototype evaluation only',
      similarities: ['Stage IVA', 'Adenocarcinoma', 'EGFR-positive', 'ECOG 1', 'Hypertension'],
      differences: [
        {
          feature: 'Metastasenlokalisation',
          currentPatient: 'not documented',
          comparisonCase: 'isolierte Nebennierenmetastase',
        },
        {
          feature: 'Intervention',
          currentPatient: 'not documented',
          comparisonCase: 'zusätzliche lokale Ablation',
        },
      ],
      takeaway: 'Ein seltener NSCLC-Fall mit spezieller Metastasenlokalisation, der die Verallgemeinerbarkeit auf Standardfälle reduziert.',
    },
  ],
};
